...
namespace Books.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,ReleaseDate,Price,Image,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,ReleaseDate,Price,Image,AuthorId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
